...
<div class="centra960">
	...
	<div class="derecha_productos">
		...
		<br /><br />
		<b>Ponti:</b> La marca #1 de acetos balsámicos y vinagres en Italia llega a nuestro país junto con la más exquisita línea de vegetales y condimentos listos para disfrutar. Sus productos nacen de la detallada selección y combinación de sus materias primas, la innovación tecnológica constante, y los más estrictos estándares de higiene y calidad. 
		<br /><br />
		<b>Acetos Balsámicos de Módena:</b> Extraordinarios en la cocina y excelentes en la mesa, los acetos balsámicos de Modena Ponti son el resultado de una mezcla exquisita entre los mostos de uva seleccionados y el vinagre de vino, seguidos por un período de maduración certificado en barricas de roble, lo que otorga su sabor único e irresistible.
		<br /><br />
		<b>Glasa gastronómica:</b> Ingredientes de calidad superior, baja acidez, alta densidad, sabor agridulce, aroma de mosto cocido, oscuro y brillante: estas son las características del Ponti Glaze, un éxito internacional para tus comidas.
		<br /><br />
		<b>Vegetales en aceite:</b> El más variado antipasto italiano, utilizando materias primas frescas y recetas tradicionales. Llega a la Argentina con sus mejores sabores: Morrones, tomates secos, alcauciles, berenjenas y pesto: el sabor ideal para resaltar todas tus comidas. Pastas, picadas, asados y donde quiera que Ponti lleve a tu creatividad.
		<br /><br />
		<div class="contiene_producto">
			...
			<div class="titulo_producto">Ponti<br />Aceto Balsámico <br> Di Modena</div>
			Botella x 250ml
		</div>
		<div class="contiene_producto">
		...
		<div class="contiene_producto">
			...
			<div class="titulo_producto">Ponti<br />Aceto Balsámico<br>Di Modena Spray</div>
			Botella Spray x 250ml
		</div>
		<div class="contiene_producto">
			...
			<div class="titulo_producto" style="padding-bottom:4px!important;">Ponti<br />Aceto Balsámico <br> Di Modena Cápsula Oro 12M</div>
			Botella x 250ml
		</div>
		...
		<div class="contiene_producto">
			...
			<div class="titulo_producto" style="padding-bottom:4px!important;">Ponti<br />Glassa Gastronómica <br> al Aceto Balsámico</div>
			Botella PET 250 ml
		</div>
		<div class="contiene_producto">
			...
			<div class="titulo_producto">Ponti<br />Aceto Balsámico <br> Di Modena HD</div>
			Botella c/Estuche x 250ml
		...
		<div class="contiene_producto">
			...
			<div class="titulo_producto" style="padding-bottom:3px">Ponti<br />Glassa Gastronómica <br /> a la soja</div>
			Botella PET 250ml
		</div>
